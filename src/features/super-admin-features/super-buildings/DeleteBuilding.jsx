...
const DeleteBuilding = ({ onCloseModal, buildingId }) => {
  const { mutate, isPending: isDeleting } = useDeleteBuilding();
  ...
  return (
    <ConfirmationContainer>
      <p>هل أنت متأكد من حذف المبني لا يمكن التراجع عن هذا الإجراء.</p>
      <ButtonGroup>
        <Button
          disabled={isDeleting}
          variation="secondary"
