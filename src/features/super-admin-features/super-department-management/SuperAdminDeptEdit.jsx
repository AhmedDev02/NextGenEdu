...
const SuperAdminDeptEdit = () => {
      ...
      <ControlledContainer>
          ...
          <Div style={{justifyContent:"space-between" , flexDirection:"row"}}>
            ...
            <StyledIconbutton>
             ...
             <Styledbutton style={{width:"20%", background:"linear-gradient(to bottom, #FF3D60, #B82D42)"}}>حفظ</Styledbutton>
         </Div>

          <Div style={{justifyContent:"flex-end" , flexDirection:"row"}}>
             <Styledbutton style={{width:"30%"}}>حفظ</Styledbutton>
         </Div>
  ...
  export default SuperAdminDeptEdit;