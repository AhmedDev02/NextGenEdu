...
import AdminProfilePic from "./SubSuperAdminProfilePic";
import AdminProfileForm from "./SubSuperAdminProfileForm";
...
function SubSuperAdminProfileContent() {
...
export default SubSuperAdminProfileContent;
