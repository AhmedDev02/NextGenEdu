...
const Icon = styled.div`
  ...
  &.spin-one {
    animation: ${rotateOne} 1.5s infinite linear;
  }

  &.spin-two {
    animation: ${rotateTwo} 2s infinite linear;
  }
`;
...
export default function MaintenancePage() {
  ...
  return (
    <Container>
      <Box>
        <Animation>
          <Icon className="spin-one" bg={iconOne} />
          <Icon className="spin-two" bg={iconTwo} size="100px" />
          <Icon className="spin-one" bg={iconThree} />
        </Animation>
        <Title>تحت الصيانة</Title>
        <Message> نحن نعمل على تحسين تجربتكم، وسنعود قريبًا.</Message>
        <Message>
